...
class KlBoomConditiebeoordeling(KeuzelijstField):
    ...
    options = {
        '0': KeuzelijstWaarde(invulwaarde='0',
                              ...
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBoomConditiebeoordeling/0'),
        '1': KeuzelijstWaarde(invulwaarde='1',
                              ...
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBoomConditiebeoordeling/1'),
        '2': KeuzelijstWaarde(invulwaarde='2',
                              ...
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBoomConditiebeoordeling/2'),
        '3': KeuzelijstWaarde(invulwaarde='3',
                              ...
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBoomConditiebeoordeling/3')
    }
