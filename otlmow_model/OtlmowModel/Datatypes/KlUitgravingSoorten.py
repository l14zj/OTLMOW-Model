...
class KlUitgravingSoorten(KeuzelijstField):
    ...
    options = {
        'compacte-grond': KeuzelijstWaarde(invulwaarde='compacte-grond',
                                           ...
                                           objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlUitgravingSoorten/compacte-grond'),
        'losse-grond': KeuzelijstWaarde(invulwaarde='losse-grond',
                                        label='losse grond',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='Uitgraving van losse grond.',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlUitgravingSoorten/losse-grond'),
        'plaatselijke-uitvoering': KeuzelijstWaarde(invulwaarde='plaatselijke-uitvoering',
                                                    ...
                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlUitgravingSoorten/plaatselijke-uitvoering'),
        'rotsachtige-grond': KeuzelijstWaarde(invulwaarde='rotsachtige-grond',
                                              ...
                                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlUitgravingSoorten/rotsachtige-grond')
    }
