...
class KlBetonomgevingsklasse(KeuzelijstField):
    ...
    options = {
        'e-0': KeuzelijstWaarde(invulwaarde='e-0',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-0'),
        'e-a-1': KeuzelijstWaarde(invulwaarde='e-a-1',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-a-1'),
        'e-a-2': KeuzelijstWaarde(invulwaarde='e-a-2',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-a-2'),
        'e-a-3': KeuzelijstWaarde(invulwaarde='e-a-3',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-a-3'),
        'e-e-1': KeuzelijstWaarde(invulwaarde='e-e-1',
                                  label='EE1',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='Buitenomgeving : geen vorst.',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-e-1'),
        'e-e-2': KeuzelijstWaarde(invulwaarde='e-e-2',
                                  label='EE2',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='Buitenomgeving : vorst, geen contact met regen.',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-e-2'),
        'e-e-3': KeuzelijstWaarde(invulwaarde='e-e-3',
                                  label='EE3',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='Buitenomgeving : vorst, contact met regen.',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-e-3'),
        'e-e-4': KeuzelijstWaarde(invulwaarde='e-e-4',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-e-4'),
        'e-s-1': KeuzelijstWaarde(invulwaarde='e-s-1',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-s-1'),
        'e-s-2': KeuzelijstWaarde(invulwaarde='e-s-2',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-s-2'),
        'e-s-3': KeuzelijstWaarde(invulwaarde='e-s-3',
                                  label='ES3',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='Zeeomgeving : contact met zeewater en ondergedompeld.',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-s-3'),
        'e-s-4': KeuzelijstWaarde(invulwaarde='e-s-4',
                                  label='ES4',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='Zeeomgeving : contact met zeewater en getijden- en spatzone.',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/e-s-4'),
        'ei': KeuzelijstWaarde(invulwaarde='ei',
                               label='EI',
                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                               definitie='Binnenomgeving.',
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBetonomgevingsklasse/ei')
    }
