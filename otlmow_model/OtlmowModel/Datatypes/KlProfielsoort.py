...
class KlProfielsoort(KeuzelijstField):
    ...
    options = {
        'hd': KeuzelijstWaarde(invulwaarde='hd',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/hd'),
        'hea': KeuzelijstWaarde(invulwaarde='hea',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/hea'),
        'heb': KeuzelijstWaarde(invulwaarde='heb',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/heb'),
        'hem': KeuzelijstWaarde(invulwaarde='hem',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/hem'),
        'hp-bulbstaal': KeuzelijstWaarde(invulwaarde='hp-bulbstaal',
                                         label='HP (bulbstaal)',
                                         status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                         definitie='Een massief profiel : Hollandprofiel (afgekort HP).',
                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/hp-bulbstaal'),
        'ipe': KeuzelijstWaarde(invulwaarde='ipe',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/ipe'),
        'ipn': KeuzelijstWaarde(invulwaarde='ipn',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/ipn'),
        'upe': KeuzelijstWaarde(invulwaarde='upe',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/upe'),
        'upn': KeuzelijstWaarde(invulwaarde='upn',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlProfielsoort/upn')
    }
