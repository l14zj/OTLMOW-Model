...
class KlDeurType(KeuzelijstField):
    ...
    options = {
        'branddeur': KeuzelijstWaarde(invulwaarde='branddeur',
                                      ...
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='Branddeur',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlDeurType/branddeur'),
        'dienstdeur': KeuzelijstWaarde(invulwaarde='dienstdeur',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlDeurType/dienstdeur'),
        'interventiedeur': KeuzelijstWaarde(invulwaarde='interventiedeur',
                                            ...
                                            objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlDeurType/interventiedeur'),
        'kopdeur': KeuzelijstWaarde(invulwaarde='kopdeur',
                                    ...
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlDeurType/kopdeur'),
        'nooddeur': KeuzelijstWaarde(invulwaarde='nooddeur',
                                     label='Nooddeur',
                                     status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                     definitie='Nooddeur',
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlDeurType/nooddeur'),
        'toegangsdeur': KeuzelijstWaarde(invulwaarde='toegangsdeur',
                                         label='Toegangsdeur',
                                         status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                         definitie='Elke deur die geen specifieke rol vervult.',
                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlDeurType/toegangsdeur'),
        'vluchtdeur': KeuzelijstWaarde(invulwaarde='vluchtdeur',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlDeurType/vluchtdeur')
    }
