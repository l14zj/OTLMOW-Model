...
class KlCabineLokaalKlasse(KeuzelijstField):
    ...
    options = {
        'BB00': KeuzelijstWaarde(invulwaarde='BB00',
                                 label='BB00',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCabineLokaalKlasse/BB00'),
        'BB05': KeuzelijstWaarde(invulwaarde='BB05',
                                 label='BB05',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCabineLokaalKlasse/BB05'),
        'BB10': KeuzelijstWaarde(invulwaarde='BB10',
                                 label='BB10',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCabineLokaalKlasse/BB10'),
        'BB20': KeuzelijstWaarde(invulwaarde='BB20',
                                 label='BB20',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCabineLokaalKlasse/BB20'),
        'BB30': KeuzelijstWaarde(invulwaarde='BB30',
                                 label='BB30',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCabineLokaalKlasse/BB30'),
        'BB40': KeuzelijstWaarde(invulwaarde='BB40',
                                 label='BB40',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCabineLokaalKlasse/BB40'),
        'BB50': KeuzelijstWaarde(invulwaarde='BB50',
                                 label='BB50',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCabineLokaalKlasse/BB50')
    }
