...
class KlZelfsluiterSluitkrachtnorm(KeuzelijstField):
    ...
    options = {
        'en-2': KeuzelijstWaarde(invulwaarde='en-2',
                                 label='EN 2',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlZelfsluiterSluitkrachtnorm/en-2'),
        'en-4': KeuzelijstWaarde(invulwaarde='en-4',
                                 label='EN 4',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlZelfsluiterSluitkrachtnorm/en-4'),
        'en-6': KeuzelijstWaarde(invulwaarde='en-6',
                                 label='EN 6',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlZelfsluiterSluitkrachtnorm/en-6')
    }
