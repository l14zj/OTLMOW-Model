...
class KlNetwerkpoortType(KeuzelijstField):
    ...
    options = {
        'NNI': KeuzelijstWaarde(invulwaarde='NNI',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNetwerkpoortType/NNI'),
        'NULL': KeuzelijstWaarde(invulwaarde='NULL',
                                 label='NULL',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='Geen interface.',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNetwerkpoortType/NULL'),
        'Other': KeuzelijstWaarde(invulwaarde='Other',
                                  label='Other',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='Ander, onbekend type interface.',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNetwerkpoortType/Other'),
        'UNI': KeuzelijstWaarde(invulwaarde='UNI',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNetwerkpoortType/UNI'),
        'e-nni': KeuzelijstWaarde(invulwaarde='e-nni',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNetwerkpoortType/e-nni'),
        'i-uni': KeuzelijstWaarde(invulwaarde='i-uni',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNetwerkpoortType/i-uni'),
        'ncni': KeuzelijstWaarde(invulwaarde='ncni',
                                 label='NCNI',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='Een Not Configured Network Interface.',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNetwerkpoortType/ncni')
    }
