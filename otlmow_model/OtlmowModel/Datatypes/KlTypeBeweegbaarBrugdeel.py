...
class KlTypeBeweegbaarBrugdeel(KeuzelijstField):
    ...
    options = {
        'basculebrug': KeuzelijstWaarde(invulwaarde='basculebrug',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/basculebrug'),
        'draaibrug': KeuzelijstWaarde(invulwaarde='draaibrug',
                                      ...
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/draaibrug'),
        'geen-standaardtype': KeuzelijstWaarde(invulwaarde='geen-standaardtype',
                                               ...
                                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/geen-standaardtype'),
        'hefbrug': KeuzelijstWaarde(invulwaarde='hefbrug',
                                    ...
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/hefbrug'),
        'helft-dubbele-basculebrug': KeuzelijstWaarde(invulwaarde='helft-dubbele-basculebrug',
                                                      ...
                                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/helft-dubbele-basculebrug'),
        'klapbrug': KeuzelijstWaarde(invulwaarde='klapbrug',
                                     ...
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/klapbrug'),
        'ophaalbrug': KeuzelijstWaarde(invulwaarde='ophaalbrug',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/ophaalbrug'),
        'pontonbrug': KeuzelijstWaarde(invulwaarde='pontonbrug',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/pontonbrug'),
        'rolbasculebrug': KeuzelijstWaarde(invulwaarde='rolbasculebrug',
                                           ...
                                           objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/rolbasculebrug'),
        'rolbrug': KeuzelijstWaarde(invulwaarde='rolbrug',
                                    ...
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/rolbrug'),
        'straussbrug': KeuzelijstWaarde(invulwaarde='straussbrug',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/straussbrug'),
        'vast': KeuzelijstWaarde(invulwaarde='vast',
                                 label='Vast',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='Een brugdeel dat niet kan bewegen.',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBeweegbaarBrugdeel/vast')
    }
