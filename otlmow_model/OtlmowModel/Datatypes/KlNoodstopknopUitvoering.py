...
class KlNoodstopknopUitvoering(KeuzelijstField):
    ...
    options = {
        'draaischakelaar': KeuzelijstWaarde(invulwaarde='draaischakelaar',
                                            ...
                                            status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                            objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNoodstopknopUitvoering/draaischakelaar'),
        'drukknop': KeuzelijstWaarde(invulwaarde='drukknop',
                                     label='drukknop',
                                     status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNoodstopknopUitvoering/drukknop'),
        'met-sleutel': KeuzelijstWaarde(invulwaarde='met-sleutel',
                                        label='met sleutel',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlNoodstopknopUitvoering/met-sleutel')
    }
