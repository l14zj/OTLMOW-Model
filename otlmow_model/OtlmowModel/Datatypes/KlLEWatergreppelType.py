...
class KlLEWatergreppelType(KeuzelijstField):
    ...
    options = {
        'type-II-A-2': KeuzelijstWaarde(invulwaarde='type-II-A-2',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEWatergreppelType/type-II-A-2'),
        'type-II-B-2': KeuzelijstWaarde(invulwaarde='type-II-B-2',
                                        label='type II B 2',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='type II B 2',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEWatergreppelType/type-II-B-2'),
        'type-II-C-2': KeuzelijstWaarde(invulwaarde='type-II-C-2',
                                        label='type II C 2',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='type II C 2',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEWatergreppelType/type-II-C-2'),
        'type-II-D-2': KeuzelijstWaarde(invulwaarde='type-II-D-2',
                                        label='type II D 2',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='type II D 2',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEWatergreppelType/type-II-D-2'),
        'type-II-E-2': KeuzelijstWaarde(invulwaarde='type-II-E-2',
                                        label='type II E 2',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='type II E 2',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEWatergreppelType/type-II-E-2')
    }
