...
class KlGrondbewerking(KeuzelijstField):
    ...
    options = {
        'diepscheuren': KeuzelijstWaarde(invulwaarde='diepscheuren',
                                         ...
                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/diepscheuren'),
        'diepspittengraafmachine': KeuzelijstWaarde(invulwaarde='diepspittengraafmachine',
                                                    ...
                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/diepspittengraafmachine'),
        'egalisereneffenen': KeuzelijstWaarde(invulwaarde='egalisereneffenen',
                                              ...
                                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/egalisereneffenen'),
        'eggen': KeuzelijstWaarde(invulwaarde='eggen',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/eggen'),
        'frezen': KeuzelijstWaarde(invulwaarde='frezen',
                                   ...
                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/frezen'),
        'ploegen': KeuzelijstWaarde(invulwaarde='ploegen',
                                    ...
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/ploegen'),
        'rollen': KeuzelijstWaarde(invulwaarde='rollen',
                                   ...
                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/rollen'),
        'scheurentriltand': KeuzelijstWaarde(invulwaarde='scheurentriltand',
                                             ...
                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/scheurentriltand'),
        'scheurenvastetand': KeuzelijstWaarde(invulwaarde='scheurenvastetand',
                                              ...
                                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/scheurenvastetand'),
        'spitsfrezen': KeuzelijstWaarde(invulwaarde='spitsfrezen',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/spitsfrezen'),
        'verkruimelen': KeuzelijstWaarde(invulwaarde='verkruimelen',
                                         ...
                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbewerking/verkruimelen')
    }
