...
class KlBewegingssensorDetectiemethode(KeuzelijstField):
    ...
    options = {
        'actief-infrarood-(air)': KeuzelijstWaarde(invulwaarde='actief-infrarood-(air)',
                                                   ...
                                                   status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBewegingssensorDetectiemethode/actief-infrarood-(air)'),
        'microgolven-(hf)': KeuzelijstWaarde(invulwaarde='microgolven-(hf)',
                                             label='microgolven (HF)',
                                             status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBewegingssensorDetectiemethode/microgolven-(hf)'),
        'passief-infrarood-(pir)': KeuzelijstWaarde(invulwaarde='passief-infrarood-(pir)',
                                                    label='passief infrarood (PIR)',
                                                    status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBewegingssensorDetectiemethode/passief-infrarood-(pir)')
    }
