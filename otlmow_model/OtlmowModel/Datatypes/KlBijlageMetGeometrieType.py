...
class KlBijlageMetGeometrieType(KeuzelijstField):
    ...
    options = {
        'andere': KeuzelijstWaarde(invulwaarde='andere',
                                   ...
                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBijlageMetGeometrieType/andere'),
        'detailplan': KeuzelijstWaarde(invulwaarde='detailplan',
                                       label='detailplan',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       definitie='Een bijlage met geometrie dat het detailplan bevat.',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBijlageMetGeometrieType/detailplan'),
        'field-of-view': KeuzelijstWaarde(invulwaarde='field-of-view',
                                          ...
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBijlageMetGeometrieType/field-of-view'),
        'lengteprofiel': KeuzelijstWaarde(invulwaarde='lengteprofiel',
                                          label='lengteprofiel',
                                          status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                          definitie='Een bijlage met geometrie dat het lengteprofiel bevat.',
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBijlageMetGeometrieType/lengteprofiel'),
        'veiligheidsvoorschriften': KeuzelijstWaarde(invulwaarde='veiligheidsvoorschriften',
                                                     ...
                                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBijlageMetGeometrieType/veiligheidsvoorschriften'),
        'werkplan': KeuzelijstWaarde(invulwaarde='werkplan',
                                     label='werkplan',
                                     status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                     definitie='Een bijlage met geometrie dat een werkplan bevat',
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBijlageMetGeometrieType/werkplan')
    }
