...
class KlHulppostkastType(KeuzelijstField):
    ...
    options = {
        'a': KeuzelijstWaarde(invulwaarde='a',
                              label='a',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlHulppostkastType/a'),
        'c': KeuzelijstWaarde(invulwaarde='c',
                              label='c',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlHulppostkastType/c')
    }
