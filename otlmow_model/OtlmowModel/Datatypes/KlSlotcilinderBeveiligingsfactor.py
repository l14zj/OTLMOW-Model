...
class KlSlotcilinderBeveiligingsfactor(KeuzelijstField):
    ...
    options = {
        'skg-1-ster': KeuzelijstWaarde(invulwaarde='skg-1-ster',
                                       label='SKG 1 ster',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSlotcilinderBeveiligingsfactor/skg-1-ster'),
        'skg-2-sterren': KeuzelijstWaarde(invulwaarde='skg-2-sterren',
                                          label='SKG 2 sterren',
                                          status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSlotcilinderBeveiligingsfactor/skg-2-sterren'),
        'skg-3-sterren': KeuzelijstWaarde(invulwaarde='skg-3-sterren',
                                          label='SKG 3 sterren',
                                          status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSlotcilinderBeveiligingsfactor/skg-3-sterren')
    }
