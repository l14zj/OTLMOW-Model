...
class KlLEGCNorm(KeuzelijstField):
    ...
    options = {
        'NBN-EN-1793-1': KeuzelijstWaarde(invulwaarde='NBN-EN-1793-1',
                                          ...
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEGCNorm/NBN-EN-1793-1'),
        'NBN-EN-1793-2': KeuzelijstWaarde(invulwaarde='NBN-EN-1793-2',
                                          ...
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEGCNorm/NBN-EN-1793-2'),
        'NBN-EN-1793-5': KeuzelijstWaarde(invulwaarde='NBN-EN-1793-5',
                                          ...
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEGCNorm/NBN-EN-1793-5'),
        'NBN-EN-1793-6': KeuzelijstWaarde(invulwaarde='NBN-EN-1793-6',
                                          ...
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEGCNorm/NBN-EN-1793-6')
    }
