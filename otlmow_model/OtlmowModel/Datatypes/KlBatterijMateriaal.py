...
class KlBatterijMateriaal(KeuzelijstField):
    ...
    options = {
        'lithium-ion-(li-ion)': KeuzelijstWaarde(invulwaarde='lithium-ion-(li-ion)',
                                                 ...
                                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBatterijMateriaal/lithium-ion-(li-ion)'),
        'loodaccu-(pb)': KeuzelijstWaarde(invulwaarde='loodaccu-(pb)',
                                          label='Loodaccu (Pb)',
                                          status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBatterijMateriaal/loodaccu-(pb)'),
        'nikkel-cadmium-(nicd)': KeuzelijstWaarde(invulwaarde='nikkel-cadmium-(nicd)',
                                                  label='Nikkel-cadmium (NiCd)',
                                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBatterijMateriaal/nikkel-cadmium-(nicd)'),
        'nikkel-metaalhydride-(nimh)': KeuzelijstWaarde(invulwaarde='nikkel-metaalhydride-(nimh)',
                                                        label='Nikkel-metaalhydride (NiMH)',
                                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBatterijMateriaal/nikkel-metaalhydride-(nimh)')
    }
