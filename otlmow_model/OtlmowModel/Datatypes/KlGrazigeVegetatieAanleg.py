...
class KlGrazigeVegetatieAanleg(KeuzelijstField):
    ...
    options = {
        'aanplanting-container-planten': KeuzelijstWaarde(invulwaarde='aanplanting-container-planten',
                                                          ...
                                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/aanplanting-container-planten'),
        'aanplanting-wortelstokken': KeuzelijstWaarde(invulwaarde='aanplanting-wortelstokken',
                                                      ...
                                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/aanplanting-wortelstokken'),
        'bezaaiing': KeuzelijstWaarde(invulwaarde='bezaaiing',
                                      ...
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/bezaaiing'),
        'bezoding': KeuzelijstWaarde(invulwaarde='bezoding',
                                     ...
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/bezoding'),
        'bloemenmengsel': KeuzelijstWaarde(invulwaarde='bloemenmengsel',
                                           ...
                                           objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/bloemenmengsel'),
        'hydraulische-bezaaiing': KeuzelijstWaarde(invulwaarde='hydraulische-bezaaiing',
                                                   ...
                                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/hydraulische-bezaaiing'),
        'natuurlijke-vegetatie-ontwikkeling-door-behoud-zaadbank': KeuzelijstWaarde(invulwaarde='natuurlijke-vegetatie-ontwikkeling-door-behoud-zaadbank',
                                                                                    ...
                                                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/natuurlijke-vegetatie-ontwikkeling-door-behoud-zaadbank'),
        'natuurlijke-vegetatie-ontwikkeling-door-overbrengen-maaisel': KeuzelijstWaarde(invulwaarde='natuurlijke-vegetatie-ontwikkeling-door-overbrengen-maaisel',
                                                                                        ...
                                                                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/natuurlijke-vegetatie-ontwikkeling-door-overbrengen-maaisel'),
        'rhizomen': KeuzelijstWaarde(invulwaarde='rhizomen',
                                     label='rhizomen',
                                     status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                     definitie='Het aanleggen van een grazige vegetatie dmv rhizomen.',
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrazigeVegetatieAanleg/rhizomen')
    }
