...
class KlTypeBetonnenProfiel(KeuzelijstField):
    ...
    options = {
        'andere': KeuzelijstWaarde(invulwaarde='andere',
                                   ...
                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBetonnenProfiel/andere'),
        'i-profiel': KeuzelijstWaarde(invulwaarde='i-profiel',
                                      ...
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBetonnenProfiel/i-profiel'),
        'omgekeerd-t-profiel': KeuzelijstWaarde(invulwaarde='omgekeerd-t-profiel',
                                                ...
                                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBetonnenProfiel/omgekeerd-t-profiel'),
        'omgekeerd-u-profiel': KeuzelijstWaarde(invulwaarde='omgekeerd-u-profiel',
                                                ...
                                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBetonnenProfiel/omgekeerd-u-profiel'),
        'plaatligger': KeuzelijstWaarde(invulwaarde='plaatligger',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBetonnenProfiel/plaatligger'),
        'rechthoekige-ligger': KeuzelijstWaarde(invulwaarde='rechthoekige-ligger',
                                                ...
                                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBetonnenProfiel/rechthoekige-ligger'),
        'u-profiel': KeuzelijstWaarde(invulwaarde='u-profiel',
                                      ...
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBetonnenProfiel/u-profiel'),
        'z-profiel': KeuzelijstWaarde(invulwaarde='z-profiel',
                                      ...
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBetonnenProfiel/z-profiel')
    }
