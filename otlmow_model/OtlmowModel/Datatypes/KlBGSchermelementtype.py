...
class KlBGSchermelementtype(KeuzelijstField):
    ...
    options = {
        'bloembakelement': KeuzelijstWaarde(invulwaarde='bloembakelement',
                                            ...
                                            objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBGSchermelementtype/bloembakelement'),
        'l-element': KeuzelijstWaarde(invulwaarde='l-element',
                                      label='L-element',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='L-element',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBGSchermelementtype/l-element')
    }
