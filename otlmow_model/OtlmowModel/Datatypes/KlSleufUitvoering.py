...
class KlSleufUitvoering(KeuzelijstField):
    ...
    options = {
        'beschoeide-sleuf': KeuzelijstWaarde(invulwaarde='beschoeide-sleuf',
                                             ...
                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSleufUitvoering/beschoeide-sleuf'),
        'beschoeide-sleuf-met-voorafgraving': KeuzelijstWaarde(invulwaarde='beschoeide-sleuf-met-voorafgraving',
                                                               ...
                                                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSleufUitvoering/beschoeide-sleuf-met-voorafgraving'),
        'directional-drilling': KeuzelijstWaarde(invulwaarde='directional-drilling',
                                                 ...
                                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSleufUitvoering/directional-drilling'),
        'onderdoorpersing': KeuzelijstWaarde(invulwaarde='onderdoorpersing',
                                             label='onderdoorpersing',
                                             status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                             definitie='onderdoorpersing',
                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSleufUitvoering/onderdoorpersing'),
        'open-sleuf': KeuzelijstWaarde(invulwaarde='open-sleuf',
                                       label='open sleuf',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       definitie='open sleuf',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSleufUitvoering/open-sleuf'),
        'waterdicht-beschoeide-sleuf-met-damplanken': KeuzelijstWaarde(invulwaarde='waterdicht-beschoeide-sleuf-met-damplanken',
                                                                       ...
                                                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSleufUitvoering/waterdicht-beschoeide-sleuf-met-damplanken')
    }
