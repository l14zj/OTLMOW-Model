...
class KlLEACKerendVermogen(KeuzelijstField):
    ...
    options = {
        'H1': KeuzelijstWaarde(invulwaarde='H1',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/H1'),
        'H2': KeuzelijstWaarde(invulwaarde='H2',
                               label='H2',
                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                               definitie='hoog kerend vermogen, getest met een bus van 13 ton',
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/H2'),
        'H3': KeuzelijstWaarde(invulwaarde='H3',
                               label='H3',
                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                               definitie='hoog kerend vermogen, getest met een vrachtwagen van 16 ton',
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/H3'),
        'H4a': KeuzelijstWaarde(invulwaarde='H4a',
                                label='H4a',
                                status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                definitie='zeer hoog kerend vermogen, getest met een vrachtwagen van 30 ton',
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/H4a'),
        'H4b': KeuzelijstWaarde(invulwaarde='H4b',
                                label='H4b',
                                status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                definitie='zeer hoog kerend vermogen, getest met een vrachtwagen van 38 ton',
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/H4b'),
        'N1': KeuzelijstWaarde(invulwaarde='N1',
                               label='N1',
                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                               definitie='normaal kerend vermogen, getest met een wagen',
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/N1'),
        'N2': KeuzelijstWaarde(invulwaarde='N2',
                               label='N2',
                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                               definitie='normaal kerend vermogen, getest met een wagen aan hoge snelheid',
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/N2'),
        'T1': KeuzelijstWaarde(invulwaarde='T1',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/T1'),
        'T2': KeuzelijstWaarde(invulwaarde='T2',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/T2'),
        'T3': KeuzelijstWaarde(invulwaarde='T3',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACKerendVermogen/T3')
    }
