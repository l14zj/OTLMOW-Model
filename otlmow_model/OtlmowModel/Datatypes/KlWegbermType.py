...
class KlWegbermType(KeuzelijstField):
    ...
    options = {
        'buitenberm': KeuzelijstWaarde(invulwaarde='buitenberm',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWegbermType/buitenberm'),
        'middenberm': KeuzelijstWaarde(invulwaarde='middenberm',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWegbermType/middenberm'),
        'tussenberm': KeuzelijstWaarde(invulwaarde='tussenberm',
                                       label='tussenberm',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       definitie='Wegberm tussen twee rijbanen van een weg met meer dan ̩̩n rijbaan, de middenberm uitgezonderd. ',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWegbermType/tussenberm')
    }
