...
class KlGrondbestemming(KeuzelijstField):
    ...
    options = {
        'buiten-werfzone-of-top': KeuzelijstWaarde(invulwaarde='buiten-werfzone-of-top',
                                                   ...
                                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbestemming/buiten-werfzone-of-top'),
        'hergebruik': KeuzelijstWaarde(invulwaarde='hergebruik',
                                       label='hergebruik',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       definitie='Grond voor hergebruik.',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbestemming/hergebruik'),
        'reiniging': KeuzelijstWaarde(invulwaarde='reiniging',
                                      label='reiniging',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='Te reinigen grond.',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbestemming/reiniging'),
        'storten': KeuzelijstWaarde(invulwaarde='storten',
                                    label='storten',
                                    status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                    definitie='Grond met verwijdering naar een vergunde stortplaats.',
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbestemming/storten'),
        'tijdelijke-opslagplaats-(top)': KeuzelijstWaarde(invulwaarde='tijdelijke-opslagplaats-(top)',
                                                          ...
                                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbestemming/tijdelijke-opslagplaats-(top)'),
        'tijdelijke-werfopslagplaats': KeuzelijstWaarde(invulwaarde='tijdelijke-werfopslagplaats',
                                                        ...
                                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondbestemming/tijdelijke-werfopslagplaats')
    }
