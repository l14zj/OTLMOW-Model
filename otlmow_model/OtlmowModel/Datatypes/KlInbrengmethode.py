...
class KlInbrengmethode(KeuzelijstField):
    ...
    options = {
        'inbrengen-d-m-v-combinatie-van-meerdere-technieken': KeuzelijstWaarde(invulwaarde='inbrengen-d-m-v-combinatie-van-meerdere-technieken',
                                                                               ...
                                                                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlInbrengmethode/inbrengen-d-m-v-combinatie-van-meerdere-technieken'),
        'inbrengen-d-m-v-heien': KeuzelijstWaarde(invulwaarde='inbrengen-d-m-v-heien',
                                                  ...
                                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlInbrengmethode/inbrengen-d-m-v-heien'),
        'inbrengen-d-m-v-hoogfrequent-trillen-met-variabel-moment': KeuzelijstWaarde(invulwaarde='inbrengen-d-m-v-hoogfrequent-trillen-met-variabel-moment',
                                                                                     ...
                                                                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlInbrengmethode/inbrengen-d-m-v-hoogfrequent-trillen-met-variabel-moment'),
        'inbrengen-d-m-v-statisch-drukken': KeuzelijstWaarde(invulwaarde='inbrengen-d-m-v-statisch-drukken',
                                                             ...
                                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlInbrengmethode/inbrengen-d-m-v-statisch-drukken'),
        'inbrengen-door-voorboring-aangezet-met-betonprop-onderaan': KeuzelijstWaarde(invulwaarde='inbrengen-door-voorboring-aangezet-met-betonprop-onderaan',
                                                                                      ...
                                                                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlInbrengmethode/inbrengen-door-voorboring-aangezet-met-betonprop-onderaan'),
        'inbrengen-volgens-methode-bepaald-door-de-aannemer': KeuzelijstWaarde(invulwaarde='inbrengen-volgens-methode-bepaald-door-de-aannemer',
                                                                               ...
                                                                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlInbrengmethode/inbrengen-volgens-methode-bepaald-door-de-aannemer')
    }
