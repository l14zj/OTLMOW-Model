...
class KlSignalisatieMarkeringOpvatting(KeuzelijstField):
    ...
    options = {
        'middelenverbintenis': KeuzelijstWaarde(invulwaarde='middelenverbintenis',
                                                ...
                                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSignalisatieMarkeringOpvatting/middelenverbintenis'),
        'resultaatsverbintenis': KeuzelijstWaarde(invulwaarde='resultaatsverbintenis',
                                                  ...
                                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlSignalisatieMarkeringOpvatting/resultaatsverbintenis')
    }
