...
class KlScheurremmendeLaagType(KeuzelijstField):
    ...
    options = {
        'bitumineus-membraan-(SAMI)': KeuzelijstWaarde(invulwaarde='bitumineus-membraan-(SAMI)',
                                                       ...
                                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/bitumineus-membraan-(SAMI)'),
        'geocomposiet': KeuzelijstWaarde(invulwaarde='geocomposiet',
                                         label='geocomposiet',
                                         status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                         definitie='geocomposiet',
                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/geocomposiet'),
        'geocomposiet-klasse-c': KeuzelijstWaarde(invulwaarde='geocomposiet-klasse-c',
                                                  ...
                                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/geocomposiet-klasse-c'),
        'geocomposiet-klasse-cd': KeuzelijstWaarde(invulwaarde='geocomposiet-klasse-cd',
                                                   ...
                                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/geocomposiet-klasse-cd'),
        'geocomposiet-klasse-d': KeuzelijstWaarde(invulwaarde='geocomposiet-klasse-d',
                                                  ...
                                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/geocomposiet-klasse-d'),
        'geocomposiet-klasse-e-1': KeuzelijstWaarde(invulwaarde='geocomposiet-klasse-e-1',
                                                    ...
                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/geocomposiet-klasse-e-1'),
        'geocomposiet-klasse-e-2': KeuzelijstWaarde(invulwaarde='geocomposiet-klasse-e-2',
                                                    ...
                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/geocomposiet-klasse-e-2'),
        'grids': KeuzelijstWaarde(invulwaarde='grids',
                                  label='grids',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='grids',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/grids'),
        'grids-klasse-c': KeuzelijstWaarde(invulwaarde='grids-klasse-c',
                                           label='grids klasse C',
                                           status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                           definitie='grids klasse C',
                                           objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/grids-klasse-c'),
        'grids-klasse-cd': KeuzelijstWaarde(invulwaarde='grids-klasse-cd',
                                            label='grids klasse CD',
                                            status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                            definitie='grids klasse CD',
                                            objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/grids-klasse-cd'),
        'grids-klasse-d': KeuzelijstWaarde(invulwaarde='grids-klasse-d',
                                           label='grids klasse D',
                                           status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                           definitie='grids klasse D',
                                           objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/grids-klasse-d'),
        'grids-klasse-e-1': KeuzelijstWaarde(invulwaarde='grids-klasse-e-1',
                                             label='grids klasse E1',
                                             status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                             definitie='grids klasse E1',
                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/grids-klasse-e-1'),
        'grids-klasse-e-2': KeuzelijstWaarde(invulwaarde='grids-klasse-e-2',
                                             label='grids klasse E2',
                                             status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                             definitie='grids klasse E2',
                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/grids-klasse-e-2'),
        'stalen-wapeningsnet-type-1': KeuzelijstWaarde(invulwaarde='stalen-wapeningsnet-type-1',
                                                       ...
                                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/stalen-wapeningsnet-type-1'),
        'stalen-wapeningsnet-type-2': KeuzelijstWaarde(invulwaarde='stalen-wapeningsnet-type-2',
                                                       ...
                                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlScheurremmendeLaagType/stalen-wapeningsnet-type-2')
    }
