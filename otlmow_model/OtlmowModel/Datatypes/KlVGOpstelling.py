...
class KlVGOpstelling(KeuzelijstField):
    ...
    options = {
        'gebogen': KeuzelijstWaarde(invulwaarde='gebogen',
                                    ...
                                    status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                    definitie='Gebogen',
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVGOpstelling/gebogen'),
        'loodrecht-op-maaiveld': KeuzelijstWaarde(invulwaarde='loodrecht-op-maaiveld',
                                                  ...
                                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVGOpstelling/loodrecht-op-maaiveld'),
        'schuin-naar-achter-hellend': KeuzelijstWaarde(invulwaarde='schuin-naar-achter-hellend',
                                                       ...
                                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVGOpstelling/schuin-naar-achter-hellend'),
        'schuin-naar-voor-hellend': KeuzelijstWaarde(invulwaarde='schuin-naar-voor-hellend',
                                                     ...
                                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVGOpstelling/schuin-naar-voor-hellend'),
        'taludvorm': KeuzelijstWaarde(invulwaarde='taludvorm',
                                      label='taludvorm',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='Taludvorm',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVGOpstelling/taludvorm'),
        'taludvorm---vertikaal': KeuzelijstWaarde(invulwaarde='taludvorm---vertikaal',
                                                  ...
                                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVGOpstelling/taludvorm---vertikaal'),
        'verticaal': KeuzelijstWaarde(invulwaarde='verticaal',
                                      label='verticaal',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='Verticaal',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVGOpstelling/verticaal')
    }
