...
class KlVegetatiePlantverband(KeuzelijstField):
    ...
    options = {
        'geschrankt': KeuzelijstWaarde(invulwaarde='geschrankt',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVegetatiePlantverband/geschrankt'),
        'rijafstand': KeuzelijstWaarde(invulwaarde='rijafstand',
                                       label='rijafstand',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       definitie='De afstand tussen de rijen',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVegetatiePlantverband/rijafstand')
    }
