...
class KlAfgravingSoorten(KeuzelijstField):
    ...
    options = {
        '20-cm': KeuzelijstWaarde(invulwaarde='20-cm',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAfgravingSoorten/20-cm'),
        'op-veranderlijke-dikte': KeuzelijstWaarde(invulwaarde='op-veranderlijke-dikte',
                                                   ...
                                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAfgravingSoorten/op-veranderlijke-dikte'),
        'plaatselijke-uitvoering': KeuzelijstWaarde(invulwaarde='plaatselijke-uitvoering',
                                                    ...
                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAfgravingSoorten/plaatselijke-uitvoering')
    }
