...
class KlKokerTypeFundering(KeuzelijstField):
    ...
    options = {
        'niet-gekend': KeuzelijstWaarde(invulwaarde='niet-gekend',
                                        label='niet gekend',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlKokerTypeFundering/niet-gekend'),
        'niet-opgenomen-in-de-lijst': KeuzelijstWaarde(invulwaarde='niet-opgenomen-in-de-lijst',
                                                       label='niet opgenomen in de lijst',
                                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlKokerTypeFundering/niet-opgenomen-in-de-lijst'),
        'op-palen': KeuzelijstWaarde(invulwaarde='op-palen',
                                     label='op palen',
                                     status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlKokerTypeFundering/op-palen'),
        'op-staal': KeuzelijstWaarde(invulwaarde='op-staal',
                                     label='op staal',
                                     status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlKokerTypeFundering/op-staal'),
        'putfundering': KeuzelijstWaarde(invulwaarde='putfundering',
                                         label='putfundering',
                                         status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlKokerTypeFundering/putfundering')
    }
