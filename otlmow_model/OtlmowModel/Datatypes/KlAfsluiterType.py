...
class KlAfsluiterType(KeuzelijstField):
    ...
    options = {
        'steekschuif': KeuzelijstWaarde(invulwaarde='steekschuif',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAfsluiterType/steekschuif'),
        'wandafsluiter': KeuzelijstWaarde(invulwaarde='wandafsluiter',
                                          label='wandafsluiter',
                                          status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                          definitie='Een afsluiter voor de beheersing van water',
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAfsluiterType/wandafsluiter')
    }
