...
class KlAfdichtingType(KeuzelijstField):
    ...
    options = {
        'gietasfalt': KeuzelijstWaarde(invulwaarde='gietasfalt',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAfdichtingType/gietasfalt'),
        'hars': KeuzelijstWaarde(invulwaarde='hars',
                                 ...
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAfdichtingType/hars'),
        'membraan': KeuzelijstWaarde(invulwaarde='membraan',
                                     ...
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAfdichtingType/membraan')
    }
