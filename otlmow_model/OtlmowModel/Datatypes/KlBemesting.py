...
class KlBemesting(KeuzelijstField):
    ...
    options = {
        'meststoffen': KeuzelijstWaarde(invulwaarde='meststoffen',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBemesting/meststoffen'),
        'meststoftabletten': KeuzelijstWaarde(invulwaarde='meststoftabletten',
                                              ...
                                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBemesting/meststoftabletten')
    }
