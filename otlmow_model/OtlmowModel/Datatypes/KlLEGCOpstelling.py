...
class KlLEGCOpstelling(KeuzelijstField):
    ...
    options = {
        'concaaf': KeuzelijstWaarde(invulwaarde='concaaf',
                                    ...
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEGCOpstelling/concaaf'),
        'schuin-naar-achter-hellend': KeuzelijstWaarde(invulwaarde='schuin-naar-achter-hellend',
                                                       ...
                                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEGCOpstelling/schuin-naar-achter-hellend'),
        'schuin-naar-voor-hellend': KeuzelijstWaarde(invulwaarde='schuin-naar-voor-hellend',
                                                     ...
                                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEGCOpstelling/schuin-naar-voor-hellend'),
        'verticaal': KeuzelijstWaarde(invulwaarde='verticaal',
                                      label='verticaal',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='verticaal t.o.v. de weg',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEGCOpstelling/verticaal')
    }
