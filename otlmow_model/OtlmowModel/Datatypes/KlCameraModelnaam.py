...
class KlCameraModelnaam(KeuzelijstField):
    ...
    options = {
        'dinion-ip-starlight-8000-m': KeuzelijstWaarde(invulwaarde='dinion-ip-starlight-8000-m',
                                                       ...
                                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCameraModelnaam/dinion-ip-starlight-8000-m'),
        'icar-cam5': KeuzelijstWaarde(invulwaarde='icar-cam5',
                                      label='iCar cam5',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='iCar cam5',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCameraModelnaam/icar-cam5'),
        'ulisse-hd': KeuzelijstWaarde(invulwaarde='ulisse-hd',
                                      label='Ulisse HD',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='Ulisse HD',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlCameraModelnaam/ulisse-hd')
    }
