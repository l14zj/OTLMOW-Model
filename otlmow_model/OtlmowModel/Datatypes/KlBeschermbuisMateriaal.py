...
class KlBeschermbuisMateriaal(KeuzelijstField):
    ...
    options = {
        'hdpe': KeuzelijstWaarde(invulwaarde='hdpe',
                                 ...
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='HDPE',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBeschermbuisMateriaal/hdpe'),
        'hdpe-pn10': KeuzelijstWaarde(invulwaarde='hdpe-pn10',
                                      label='HDPE PN10',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBeschermbuisMateriaal/hdpe-pn10'),
        'hdpe-sdr17': KeuzelijstWaarde(invulwaarde='hdpe-sdr17',
                                       label='HDPE SDR17',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       definitie='HDPE SDR17',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBeschermbuisMateriaal/hdpe-sdr17'),
        'opticalfiber': KeuzelijstWaarde(invulwaarde='opticalfiber',
                                         label='opticalFiber',
                                         status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                         definitie='opticalFiber',
                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBeschermbuisMateriaal/opticalfiber'),
        'pe': KeuzelijstWaarde(invulwaarde='pe',
                               label='PE',
                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                               definitie='PE',
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBeschermbuisMateriaal/pe'),
        'pvc': KeuzelijstWaarde(invulwaarde='pvc',
                                label='PVC',
                                status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                definitie='PVC',
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBeschermbuisMateriaal/pvc'),
        'rvs': KeuzelijstWaarde(invulwaarde='rvs',
                                label='RVS',
                                status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBeschermbuisMateriaal/rvs')
    }
