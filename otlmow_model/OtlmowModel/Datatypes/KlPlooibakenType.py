...
class KlPlooibakenType(KeuzelijstField):
    ...
    options = {
        'plooibaken-diameter-130-mm---M24': KeuzelijstWaarde(invulwaarde='plooibaken-diameter-130-mm---M24',
                                                             ...
                                                             status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                             definitie='Plooibaken diameter 130 mm Ã¢â‚¬â€œ M24',
                                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlPlooibakenType/plooibaken-diameter-130-mm---M24'),
        'plooibaken-diameter-80-mm---M16': KeuzelijstWaarde(invulwaarde='plooibaken-diameter-80-mm---M16',
                                                            ...
                                                            status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                            definitie='Plooibaken diameter 80 mm Ã¢â‚¬â€œ M16',
                                                            objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlPlooibakenType/plooibaken-diameter-80-mm---M16'),
        'plooibaken-diameter-80-mm---M24': KeuzelijstWaarde(invulwaarde='plooibaken-diameter-80-mm---M24',
                                                            ...
                                                            status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                                            definitie='Plooibaken diameter 80 mm Ã¢â‚¬â€œ M24',
                                                            objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlPlooibakenType/plooibaken-diameter-80-mm---M24'),
        'verkeerszuil': KeuzelijstWaarde(invulwaarde='verkeerszuil',
                                         label='verkeerszuil',
                                         status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                         definitie='Verkeerszuil',
                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlPlooibakenType/verkeerszuil')
    }
