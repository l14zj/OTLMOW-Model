...
class KlKwaliteitsklasseHout(KeuzelijstField):
    ...
    options = {
        'klasse-a': KeuzelijstWaarde(invulwaarde='klasse-a',
                                     ...
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlKwaliteitsklasseHout/klasse-a'),
