...
class KlTypeBrugdeel(KeuzelijstField):
    ...
    options = {
        'baileybrug': KeuzelijstWaarde(invulwaarde='baileybrug',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/baileybrug'),
        'boogbrug': KeuzelijstWaarde(invulwaarde='boogbrug',
                                     ...
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/boogbrug'),
        'bowstringbrug': KeuzelijstWaarde(invulwaarde='bowstringbrug',
                                          ...
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/bowstringbrug'),
        'hangbrug': KeuzelijstWaarde(invulwaarde='hangbrug',
                                     ...
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/hangbrug'),
        'liggerbrug-balk-en-met-constante-hoogte': KeuzelijstWaarde(invulwaarde='liggerbrug-balk-en-met-constante-hoogte',
                                                                    ...
                                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/liggerbrug-balk-en-met-constante-hoogte'),
        'liggerbrug-balk-en-met-veranderlijke-hoogte': KeuzelijstWaarde(invulwaarde='liggerbrug-balk-en-met-veranderlijke-hoogte',
                                                                        ...
                                                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/liggerbrug-balk-en-met-veranderlijke-hoogte'),
        'liggerbrug-koker-s-met-constante-hoogte': KeuzelijstWaarde(invulwaarde='liggerbrug-koker-s-met-constante-hoogte',
                                                                    ...
                                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/liggerbrug-koker-s-met-constante-hoogte'),
        'liggerbrug-koker-s-met-veranderlijke-hoogte': KeuzelijstWaarde(invulwaarde='liggerbrug-koker-s-met-veranderlijke-hoogte',
                                                                        ...
                                                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/liggerbrug-koker-s-met-veranderlijke-hoogte'),
        'niet-gekend': KeuzelijstWaarde(invulwaarde='niet-gekend',
                                        label='niet gekend',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='Het type brugdeel is onbekend.	',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/niet-gekend'),
        'plaatbrug': KeuzelijstWaarde(invulwaarde='plaatbrug',
                                      label='plaatbrug',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='Het brugdek wordt gevormd met een plaat.',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/plaatbrug'),
        'portaalbrug-met-liggers': KeuzelijstWaarde(invulwaarde='portaalbrug-met-liggers',
                                                    ...
                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/portaalbrug-met-liggers'),
        'portaalbrug-met-plaat': KeuzelijstWaarde(invulwaarde='portaalbrug-met-plaat',
                                                  ...
                                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/portaalbrug-met-plaat'),
        'tuibrug': KeuzelijstWaarde(invulwaarde='tuibrug',
                                    ...
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/tuibrug'),
        'vakwerkbrug': KeuzelijstWaarde(invulwaarde='vakwerkbrug',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/vakwerkbrug'),
        'vierendeelbrug': KeuzelijstWaarde(invulwaarde='vierendeelbrug',
                                           ...
                                           objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdeel/vierendeelbrug')
    }
