...
class KlBestrijkingProductfamilie(KeuzelijstField):
    ...
    options = {
        '1': KeuzelijstWaarde(invulwaarde='1',
                              ...
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingProductfamilie/1'),
        '2': KeuzelijstWaarde(invulwaarde='2',
                              label='2',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='Productfamilie 2',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingProductfamilie/2'),
        '3': KeuzelijstWaarde(invulwaarde='3',
                              label='3',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='Productfamilie 3',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingProductfamilie/3'),
        '4': KeuzelijstWaarde(invulwaarde='4',
                              label='4',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='Productfamilie 4',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingProductfamilie/4'),
        '5': KeuzelijstWaarde(invulwaarde='5',
                              label='5',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='Productfamilie 5',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingProductfamilie/5'),
        '6': KeuzelijstWaarde(invulwaarde='6',
                              label='6',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='Productfamilie 6',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingProductfamilie/6'),
        '7': KeuzelijstWaarde(invulwaarde='7',
                              label='7',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='Productfamilie 7',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingProductfamilie/7'),
        '8': KeuzelijstWaarde(invulwaarde='8',
                              label='8',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='Productfamilie 8',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingProductfamilie/8')
    }
