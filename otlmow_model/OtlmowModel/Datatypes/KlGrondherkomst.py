...
class KlGrondherkomst(KeuzelijstField):
    ...
    options = {
        'aanbestedende-overheid': KeuzelijstWaarde(invulwaarde='aanbestedende-overheid',
                                                   ...
                                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondherkomst/aanbestedende-overheid'),
        'ander-project': KeuzelijstWaarde(invulwaarde='ander-project',
                                          label='ander project',
                                          status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                          definitie='Grond afkomstig van een ander project.',
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondherkomst/ander-project'),
        'de-aannemer': KeuzelijstWaarde(invulwaarde='de-aannemer',
                                        label='de aannemer',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='Grond geleverd door de aannemer.',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondherkomst/de-aannemer'),
        'gezeefde-gronden': KeuzelijstWaarde(invulwaarde='gezeefde-gronden',
                                             ...
                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondherkomst/gezeefde-gronden'),
        'werfzone': KeuzelijstWaarde(invulwaarde='werfzone',
                                     label='werfzone',
                                     status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                     definitie='Grond afkomstig van binnen de werfzone.',
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrondherkomst/werfzone')
    }
