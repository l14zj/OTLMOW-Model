...
class KlVerkeersregelaarModelnaam(KeuzelijstField):
    ...
    options = {
        'civa-2020': KeuzelijstWaarde(invulwaarde='civa-2020',
                                      ...
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='CIVA 2020',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVerkeersregelaarModelnaam/civa-2020'),
        'flow-node': KeuzelijstWaarde(invulwaarde='flow-node',
                                      label='FlowNode',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='FlowNode',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVerkeersregelaarModelnaam/flow-node'),
        'flow-nodes': KeuzelijstWaarde(invulwaarde='flow-nodes',
                                       label='FlowNodes',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       definitie='FlowNodes',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVerkeersregelaarModelnaam/flow-nodes'),
        'sx': KeuzelijstWaarde(invulwaarde='sx',
                               label='SX',
                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                               definitie='SX',
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlVerkeersregelaarModelnaam/sx')
    }
