...
class KlWvLedKleurTemp(KeuzelijstField):
    ...
    options = {
        '1700': KeuzelijstWaarde(invulwaarde='1700',
                                 label='1700',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWvLedKleurTemp/1700'),
        '2200': KeuzelijstWaarde(invulwaarde='2200',
                                 label='2200',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='2200',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWvLedKleurTemp/2200'),
        '2900': KeuzelijstWaarde(invulwaarde='2900',
                                 label='2900',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='/ CLASS : VPLMAST',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWvLedKleurTemp/2900'),
        '3000': KeuzelijstWaarde(invulwaarde='3000',
                                 label='3000',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='3000',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWvLedKleurTemp/3000'),
        '4000': KeuzelijstWaarde(invulwaarde='4000',
                                 label='4000',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='/ CLASS : VPLMAST',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWvLedKleurTemp/4000')
    }
