...
class KlBestrijkingKaliber(KeuzelijstField):
    ...
    options = {
        '2-10': KeuzelijstWaarde(invulwaarde='2-10',
                                 ...
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingKaliber/2-10'),
        '2-4': KeuzelijstWaarde(invulwaarde='2-4',
                                label='2/4',
                                status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                definitie='kaliber 2/4',
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingKaliber/2-4'),
        '2-6.3': KeuzelijstWaarde(invulwaarde='2-6.3',
                                  label='2/6.3',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='kaliber 2/6.3',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingKaliber/2-6.3'),
        '4-10': KeuzelijstWaarde(invulwaarde='4-10',
                                 label='4/10',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='kaliber 4/10',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingKaliber/4-10'),
        '4-6.3': KeuzelijstWaarde(invulwaarde='4-6.3',
                                  label='4/6.3',
                                  status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                  definitie='kaliber 4/6.3',
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingKaliber/4-6.3'),
        '6.3-10': KeuzelijstWaarde(invulwaarde='6.3-10',
                                   label='6.3/10',
                                   status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                   definitie='kaliber 6.3/10',
                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBestrijkingKaliber/6.3-10')
    }
