...
class KlWBSSType(KeuzelijstField):
    ...
    options = {
        'gekleurde-met-anorganische-pigmenten': KeuzelijstWaarde(invulwaarde='gekleurde-met-anorganische-pigmenten',
                                                                 ...
                                                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWBSSType/gekleurde-met-anorganische-pigmenten'),
        'gekleurde-met-kleurondersteunende-granulaten': KeuzelijstWaarde(invulwaarde='gekleurde-met-kleurondersteunende-granulaten',
                                                                         ...
                                                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWBSSType/gekleurde-met-kleurondersteunende-granulaten'),
        'grijze': KeuzelijstWaarde(invulwaarde='grijze',
                                   label='grijze',
                                   status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                   definitie='grijze waterdoorlatende betonstraatstenen',
                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWBSSType/grijze'),
        'waterdoorlatende-betontegel': KeuzelijstWaarde(invulwaarde='waterdoorlatende-betontegel',
                                                        ...
                                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWBSSType/waterdoorlatende-betontegel'),
        'witte-met-kleurondersteunende-granulaten': KeuzelijstWaarde(invulwaarde='witte-met-kleurondersteunende-granulaten',
                                                                     ...
                                                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWBSSType/witte-met-kleurondersteunende-granulaten')
    }
