...
class KlLEACPerformantieklasse(KeuzelijstField):
    ...
    options = {
        'P1': KeuzelijstWaarde(invulwaarde='P1',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/P1'),
        'P2': KeuzelijstWaarde(invulwaarde='P2',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/P2'),
        'P3': KeuzelijstWaarde(invulwaarde='P3',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/P3'),
        'P4': KeuzelijstWaarde(invulwaarde='P4',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/P4'),
        't100': KeuzelijstWaarde(invulwaarde='t100',
                                 ...
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/t100'),
        't110': KeuzelijstWaarde(invulwaarde='t110',
                                 ...
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/t110'),
        't50': KeuzelijstWaarde(invulwaarde='t50',
                                label='T50',
                                status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                definitie='Beginconstructie enkel frontaal getest met een lichte wagen aan 50km/h.',
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/t50'),
        't80': KeuzelijstWaarde(invulwaarde='t80',
                                ...
                                objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/t80'),
        't80-1': KeuzelijstWaarde(invulwaarde='t80-1',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlLEACPerformantieklasse/t80-1')
    }
