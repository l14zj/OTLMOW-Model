...
class KlAlgRijstrookcode(KeuzelijstField):
    ...
    options = {
        '0': KeuzelijstWaarde(invulwaarde='0',
                              ...
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/0'),
        '1': KeuzelijstWaarde(invulwaarde='1',
                              label='1',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='meest rechtse rijstrook',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/1'),
        '2': KeuzelijstWaarde(invulwaarde='2',
                              label='2',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='tweede rijstrook van rechts te tellen',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/2'),
        '3': KeuzelijstWaarde(invulwaarde='3',
                              label='3',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='derde rijstrook van rechts te tellen',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/3'),
        '4': KeuzelijstWaarde(invulwaarde='4',
                              label='4',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='vierde rijstrook van rechts te tellen',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/4'),
        '5': KeuzelijstWaarde(invulwaarde='5',
                              label='5',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              definitie='vijfde rijstrook van rechts te tellen',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/5'),
        '6': KeuzelijstWaarde(invulwaarde='6',
                              label='6',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/6'),
        '7': KeuzelijstWaarde(invulwaarde='7',
                              label='7',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/7'),
        '8': KeuzelijstWaarde(invulwaarde='8',
                              label='8',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/8'),
        '9': KeuzelijstWaarde(invulwaarde='9',
                              label='9',
                              status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAlgRijstrookcode/9')
    }
