...
class KlMateriaalStenen(KeuzelijstField):
    ...
    options = {
        'beton': KeuzelijstWaarde(invulwaarde='beton',
                                  ...
                                  objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/beton'),
        'blauwe-hardsteen-volgens-categorie-a': KeuzelijstWaarde(invulwaarde='blauwe-hardsteen-volgens-categorie-a',
                                                                 ...
                                                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/blauwe-hardsteen-volgens-categorie-a'),
        'blauwe-hardsteen-volgens-categorie-b': KeuzelijstWaarde(invulwaarde='blauwe-hardsteen-volgens-categorie-b',
                                                                 ...
                                                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/blauwe-hardsteen-volgens-categorie-b'),
        'blauwe-hardsteen-volgens-categorie-c': KeuzelijstWaarde(invulwaarde='blauwe-hardsteen-volgens-categorie-c',
                                                                 ...
                                                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/blauwe-hardsteen-volgens-categorie-c'),
        'breuksteen': KeuzelijstWaarde(invulwaarde='breuksteen',
                                       label='Breuksteen',
                                       status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                       definitie='Breuksteen is een natuursteen van onregelmatige vorm.',
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/breuksteen'),
        'cellenbeton': KeuzelijstWaarde(invulwaarde='cellenbeton',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/cellenbeton'),
        'crino-denkalksteen': KeuzelijstWaarde(invulwaarde='crino-denkalksteen',
                                               label='CrinoÃ¯denkalksteen',
                                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                               definitie='Kalksteen met vele overblijfselen, voornamelijk stengeldelen, van Crinoiden of Haarsterren.',
                                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/crino-denkalksteen'),
        'gevelsteen': KeuzelijstWaarde(invulwaarde='gevelsteen',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/gevelsteen'),
        'kalksteen': KeuzelijstWaarde(invulwaarde='kalksteen',
                                      label='Kalksteen',
                                      status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                      definitie='Een natuursteen, ontstaan door kalkafzettingen.',
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/kalksteen'),
        'leisteen': KeuzelijstWaarde(invulwaarde='leisteen',
                                     ...
                                     objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/leisteen'),
        'natuursteen': KeuzelijstWaarde(invulwaarde='natuursteen',
                                        ...
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/natuursteen'),
        'snelbouwsteen': KeuzelijstWaarde(invulwaarde='snelbouwsteen',
                                          ...
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/snelbouwsteen'),
        'volle-baksteen': KeuzelijstWaarde(invulwaarde='volle-baksteen',
                                           ...
                                           objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/volle-baksteen'),
        'zandsteen': KeuzelijstWaarde(invulwaarde='zandsteen',
                                      ...
                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlMateriaalStenen/zandsteen')
    }
