...
class KlBoomtoestandMeerwaardefactor(KeuzelijstField):
    ...
    options = {
        '1': KeuzelijstWaarde(invulwaarde='1',
                              ...
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBoomtoestandMeerwaardefactor/1'),
        '15': KeuzelijstWaarde(invulwaarde='15',
                               ...
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBoomtoestandMeerwaardefactor/15'),
        '2': KeuzelijstWaarde(invulwaarde='2',
                              ...
                              objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBoomtoestandMeerwaardefactor/2'),
        '25': KeuzelijstWaarde(invulwaarde='25',
                               label='25',
                               status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                               definitie='De boom is individueel beschermd als monument',
                               objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlBoomtoestandMeerwaardefactor/25')
    }
