...
class KlTypeExterneNaspanning(KeuzelijstField):
    ...
    options = {
        'voorspanning-met-aanhechting': KeuzelijstWaarde(invulwaarde='voorspanning-met-aanhechting',
                                                         ...
                                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeExterneNaspanning/voorspanning-met-aanhechting'),
        'voorspanning-zonder-aanhechting': KeuzelijstWaarde(invulwaarde='voorspanning-zonder-aanhechting',
                                                            ...
                                                            objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeExterneNaspanning/voorspanning-zonder-aanhechting')
    }
