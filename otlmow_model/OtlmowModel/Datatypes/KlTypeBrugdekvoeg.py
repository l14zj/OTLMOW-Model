...
class KlTypeBrugdekvoeg(KeuzelijstField):
    ...
    options = {
        'compound-voeg': KeuzelijstWaarde(invulwaarde='compound-voeg',
                                          ...
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdekvoeg/compound-voeg'),
        'getande-voeg-met-voegband': KeuzelijstWaarde(invulwaarde='getande-voeg-met-voegband',
                                                      ...
                                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdekvoeg/getande-voeg-met-voegband'),
        'getande-voeg-zonder-voegband': KeuzelijstWaarde(invulwaarde='getande-voeg-zonder-voegband',
                                                         ...
                                                         objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdekvoeg/getande-voeg-zonder-voegband'),
        'klauwprofiel-met-voegband': KeuzelijstWaarde(invulwaarde='klauwprofiel-met-voegband',
                                                      ...
                                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdekvoeg/klauwprofiel-met-voegband'),
        'niet-gekend': KeuzelijstWaarde(invulwaarde='niet-gekend',
                                        label='Niet gekend',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='Het type brugdekvoeg is niet gekend.',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdekvoeg/niet-gekend'),
        'polymeer-voeg': KeuzelijstWaarde(invulwaarde='polymeer-voeg',
                                          label='Polymeer voeg',
                                          status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                          definitie='(Flexibele) voegovergang op basis van polymeren.',
                                          objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlTypeBrugdekvoeg/polymeer-voeg')
    }
