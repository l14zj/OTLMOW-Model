...
class KlGrachtFunctie(KeuzelijstField):
    ...
    options = {
        'baangracht': KeuzelijstWaarde(invulwaarde='baangracht',
                                       ...
                                       objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrachtFunctie/baangracht'),
        'ontwatering': KeuzelijstWaarde(invulwaarde='ontwatering',
                                        label='ontwatering',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='Ontwatering als functie van de gracht.',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrachtFunctie/ontwatering'),
        'polder': KeuzelijstWaarde(invulwaarde='polder',
                                   label='polder',
                                   status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                   definitie='Polder als functie van de gracht.',
                                   objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrachtFunctie/polder'),
        'vesting': KeuzelijstWaarde(invulwaarde='vesting',
                                    label='vesting',
                                    status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                    definitie='Vesting als functie van de gracht.',
                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlGrachtFunctie/vesting')
    }
