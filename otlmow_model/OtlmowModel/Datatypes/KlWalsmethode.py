...
class KlWalsmethode(KeuzelijstField):
    ...
    options = {
        'koud': KeuzelijstWaarde(invulwaarde='koud',
                                 ...
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWalsmethode/koud'),
        'warm': KeuzelijstWaarde(invulwaarde='warm',
                                 label='Warm',
                                 status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                 definitie='Heet staal wordt vervormd onder druk van persen en walsen.',
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWalsmethode/warm')
    }
