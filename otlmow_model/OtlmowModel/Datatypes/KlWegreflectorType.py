...
class KlWegreflectorType(KeuzelijstField):
    ...
    options = {
        'glasbolreflector-100-mm-diameter': KeuzelijstWaarde(invulwaarde='glasbolreflector-100-mm-diameter',
                                                             ...
                                                             objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWegreflectorType/glasbolreflector-100-mm-diameter'),
        'glasbolreflector-50-mm-diameter': KeuzelijstWaarde(invulwaarde='glasbolreflector-50-mm-diameter',
                                                            ...
                                                            objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWegreflectorType/glasbolreflector-50-mm-diameter'),
        'kunststof-wegdekreflector': KeuzelijstWaarde(invulwaarde='kunststof-wegdekreflector',
                                                      ...
                                                      objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWegreflectorType/kunststof-wegdekreflector'),
        'metalen-wegdekreflector': KeuzelijstWaarde(invulwaarde='metalen-wegdekreflector',
                                                    ...
                                                    objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlWegreflectorType/metalen-wegdekreflector')
    }
