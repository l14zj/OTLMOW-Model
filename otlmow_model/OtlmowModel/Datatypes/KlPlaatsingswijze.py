...
class KlPlaatsingswijze(KeuzelijstField):
    ...
    options = {
        'vast': KeuzelijstWaarde(invulwaarde='vast',
                                 ...
                                 objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlPlaatsingswijze/vast'),
        'wegneembaar': KeuzelijstWaarde(invulwaarde='wegneembaar',
                                        label='wegneembaar',
                                        status='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlAdmsStatus/ingebruik',
                                        definitie='Wegneembare plaatsing van het straatmeubilair.',
                                        objectUri='https://wegenenverkeer-test.data.vlaanderen.be/id/concept/KlPlaatsingswijze/wegneembaar')
    }
