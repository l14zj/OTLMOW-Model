...
class HoogtebegrenzerInstallatie(AIMNaamObject, LijnGeometrie):
    """een mechanische en/of elektronische opstelling dat bij kunstwerken (zoals bruggen of tunnels) de maximale doorrijhoogte van voertuigen detecteert en overtredingen voorkomt om schade te vermijden."""
