...
class HorizontaleConstructieplaat(ConstructieElementAanvaarbeschermingGeleidewerk, ConstructieElementSluisStuw, ConstructiefObject, LijnGeometrie, VlakGeometrie):
